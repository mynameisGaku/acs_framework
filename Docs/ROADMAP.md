...
| 時間・待機 | `CTimeSubsystem`、`CTimerSubsystem`、`FGameplayCooldown`、`FGameplayTimer` |
...
| 決定性 (記録と再生) | `CSimulationSubsystem`、`CDeterministicRandom`の確率判定、均等・重み付き抽選、配列シャッフル、3D箱内部・球面・球内部・円錐方向抽選 |
